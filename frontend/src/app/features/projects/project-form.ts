...
@Component({
  ...
  styles: [
    `
      ...
      .repo-row { display: grid; grid-template-columns: 1fr 1.4fr 1fr .9fr .9fr auto; gap: .4rem; margin-bottom: .4rem; }
      @media (max-width: 700px) { .inst-row, .repo-row { grid-template-columns: 1fr 1fr; } }
      .tabpad { margin-top: 1rem; }
