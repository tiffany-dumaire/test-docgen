        ...
        <div class="grid-cards" style="margin-top:1rem">
          ...
          <div class="card">
            ...
            @for (l of links(); track l.id) {
              <div class="row between" style="margin-bottom:.3rem">
                ...
                <button class="btn btn-sm btn-danger" (click)="delLink(l)">✕</button>
              </div>
            ...
            <div class="row" style="gap:.3rem;flex-wrap:wrap;margin-top:.4rem">
              ...
              <button class="btn btn-ghost btn-sm" (click)="addLink(p.id!)">+ Ajouter</button>
            </div>
          </div>
          ...
          <div class="card">
            ...
            @for (mtg of meetings(); track mtg.id) {
              <div class="row between" style="margin-bottom:.3rem">
                <div><b>{{ mtg.title }}</b> <span class="muted" style="font-size:.75rem">{{ mtg.location }}</span></div>
            ...
            <div class="row" style="gap:.3rem;flex-wrap:wrap;margin-top:.4rem">
              ...
              <button class="btn btn-ghost btn-sm" (click)="addMeeting(p.id!)">+ Ajouter</button>
            </div>
          </div>
        </div>
